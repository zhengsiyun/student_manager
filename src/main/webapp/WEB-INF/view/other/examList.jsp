...
<head>
	...
	<script type="text/javascript" src="${ctx }/easyui/themes/locale/easyui-lang-zh_CN.js"></script>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"${ctx}/exam/loadAllExam.action",
	        idField:'id', 
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除与本次考试相关的所有成绩，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "${ctx}/exam/deleteExam.action",
							data: {id: id},
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>考试时间:</td>
	    			<td><input id="add_time" style="width: 200px; height: 30px;" class="easyui-datebox" type="text" name="time" data-options="required:true, missingMessage:'请选择日期', editable:false" /></td>
	    		</tr>
	    		<tr>
	    			<td>考试类型:</td>
	    			<td>
