...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"${ctx}/grade/queryAllGrade.action",
	        idField:'id', 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除与年级相关的所有数据(包括班级,学生)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "${ctx}/grade/deleteGrade.action",
							data: {id: id},
	  	...
	  	$("#add_courseList").combobox({
	  		...
	  		editable: false, //不可编辑
	  		method: "post",
	  		url: "${ctx}/course/queryAllCourses.action"
	  	});
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>选择课程:</td>
	    			<td><select id="add_courseList" style="width: 200px; height: 30px;" name="courseid" data-options="required:true, missingMessage:'请选择课程'" ></select></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
